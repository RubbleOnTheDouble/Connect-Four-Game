...
assert BOARDWIDTH >= 4 and BOARDHEIGHT >= 4, 'the board must be at least 4x4'
...
def getComputerMove(board):
    ...
    # get the best chance from the potential moves
    bestMoveFitness = -1
    for i in range(BOARDWIDTH):
        if potentialMoves[i] > bestMoveFitness and isValidMove(board, i):
            bestMoveFitness = potentialMoves[i]
    # find all potential moves that have this best chance
    bestMoves = []
